...
<div id="respond" class="no_webshot">
	...
	<div class="comment-signarea">
		...
		<a class="btn btn-default" target="_blank" href="<?php echo site_url('/wp-login.php'); ?>"><?php echo __('登陆', 'haoui') ?></a> 
		<a class="btn btn-default" target="_blank" href="<?php echo site_url('/wp-login.php?action=register'); ?>"><?php echo __('注册', 'haoui') ?></a>
	</div>
